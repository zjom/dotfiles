...
local servers = {
  "basedpyright", "clangd", "cssls", "elixirls", "emmet_ls", "eslint", "gopls", "html", "jdtls", "emmylua_ls",
  "marksman", "nixd", "ocamllsp", "oxlint", "tofu_ls", "ruff", "rust_analyzer", "svelte", "tailwindcss", "tinymist",
  "tombi", "ts_ls", "zls"
}
